...
def leer_datos(nombre_archivo):
    with open(nombre_archivo, 'r') as f:
        ...
        T = lineas[-2]             # Penultima línea es la temperatura
        velocidades = np.array(lineas[:-2])  # Todas las anteriores son velocidades
...
# Programa principal
def main():
    archivo = 'C:/Users/User/Documents/Fisica_compu/Compu/Voluntario 1 (potencial de Lennard-Jones)/Actividad1/Temperatura.txt'  # Cambia esto por el nombre de tu archivo
    ...
    plt.legend()
    plt.grid(True)
    ruta_salida = 'C:/Users/User/Documents/Fisica_compu/Compu/Voluntario 1 (potencial de Lennard-Jones)/Actividad1/Ploteos/histograma_velocidades.png'
